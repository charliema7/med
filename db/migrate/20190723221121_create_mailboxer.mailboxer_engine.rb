...
class CreateMailboxer < ActiveRecord::Migration[4.2]
  ...
  #Tables
    #Conversations
    create_table :mailboxer_conversations, id: :uuid do |t|
      t.column :subject, :string, :default => ""
      t.column :created_at, :datetime, :null => false
      t.column :updated_at, :datetime, :null => false
    end
    #Receipts
    create_table :mailboxer_receipts, id: :uuid do |t|
    ...
    create_table :mailboxer_notifications, id: :uuid do |t|
      ...
      t.references :notified_object, :polymorphic => true, type: :uuid, index: { name: 'mailboxer_notifications_notified_object' }
  ...
  #Foreign keys
    #Conversations
    #Receipts
    add_foreign_key "mailboxer_receipts", "mailboxer_notifications", :name => "receipts_on_notification_id", :column => "notification_id", type: :uuid
    #Messages
    add_foreign_key "mailboxer_notifications", "mailboxer_conversations", :name => "notifications_on_conversation_id", :column => "conversation_id", type: :uuid
  end
